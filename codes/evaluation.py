...
def evaluate_IOU():
    """Evaluate the IOUs of the result contouring.
    ...
    for i in range(len(result_files)):
        # logger.info(result_files[i], compare_files[i])
        ...
        logger.info('Filename: ', compare_files[i], ' IOU: ', IOU)
    logger.info('Average IOU: ', round(sum(IOU_list) / 10, 3))
